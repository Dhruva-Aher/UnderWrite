...
Policy evaluation completes in under 100 ms on our demo dataset.
...
5. `python demo/run_demo.py` to watch the automated orchestrator in action.
6. Open the frontend console (Vite) to see the `reactflow` graph updates and risk score calculation!
